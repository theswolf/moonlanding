...
public class WorldController extends InputAdapter implements Disposable {
	...
	public boolean isPlayerInWater () {
		return true;//level.bunnyHead.position.y < -5;
	}
	...
	private void onCollisionBunnyHeadWithRock (Object rock) {
	...
	private void onCollisionBunnyWithGoldCoin (Object goldcoin) {
	...
	private void onCollisionBunnyWithFeather (Object feather) {
